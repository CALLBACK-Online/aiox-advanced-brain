...
source_path: content/courses/aiox-advanced/lessons/18-yaml-markdown-json-sweet-spot/lesson.md
...
- YAML: config legível, comentários | dado profundo de máquina | core-config, frontmatter, content.yaml
