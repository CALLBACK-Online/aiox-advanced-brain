...
# CLAUDE.md é a lei da física do seu projeto
...
- **2. Lei 2 - Agent Authority**: Cada agente tem autoridade exclusiva. Só @devops faz push, tag, PR, release. Só @db-sage executa migration em produção. Tentar burlar = bloqueio por hook. [AUTH, enforce-hooks]
