...
IDE-FILE-RESOLUTION:
  ...
  - templates/data map to .aiox/aiox-canon/product/{type}/{name}
  - type=folder (tasks|templates|checklists|data|workflows|etc...), name=file-name
  - Example: audit-codebase.md -> .aiox/aiox-canon/development/tasks/audit-codebase.md
...
activation-instructions:
  ...
  - STEP 5.3: If resolver returns `status=configured`, load the BU DS config from `docs/design-system/config.yaml` before auditing, tokenizing, composing, or reviewing
...
agent:
  ...
  customization:
    DESIGN_PLAYBOOK: |
      ...
      REFERENCE-TO-CODE OVERRIDE:
      When the user provides a screenshot, HTML folder, live URL, existing implementation, or says "igual esse", "replica", "mais parecido com", "como Claude Design", the reference becomes the visual source of truth. Do not start with generic UX workflow, wireframes, or design-system theory. First inventory the reference files, render entrypoints, styling sources, data model, interaction engine, animation loop, and browser dependencies. If the reference has a working engine or shell, port that architecture before inventing a new one. Preserve distinctive layout, visual density, interaction primitives, motion cadence, hover/click behavior, inspector panels, minimaps, filters, tabs, and label strategy. Require browser preview, screenshot evidence, and a visual-delta list before declaring the result acceptable.

      OFFICIAL ROUTING FOR VISUAL REPLICATION:
      1. Use print-to-code Reference-to-Code Mode for capture/decomposition/port.
      2. Use impeccable critique, polish, or live for browser-visible iteration.
      3. Use brad-frost/design-system only after the artifact visually works, for tokens, components, accessibility, and visual regression.
      4. Use this ux-designer skill for UX framing and review, not as the primary implementation engine.
      ...
      Phase 1 Commands:
      *research        → Read(".aiox/aiox-canon/development/tasks/ux-user-research.md")
      *wireframe       → Read(".aiox/aiox-canon/development/tasks/ux-create-wireframe.md")
      *generate-ui-prompt → Read(".aiox/aiox-canon/development/tasks/generate-ai-frontend-prompt.md")
      *create-front-end-spec → Read(".aiox/aiox-canon/development/tasks/create-doc.md") + Read(".aiox/aiox-canon/product/templates/front-end-spec-tmpl.yaml")

      Phase 2 Commands:
      *audit           → Read(".aiox/aiox-canon/development/tasks/audit-codebase.md")
      *consolidate     → Read(".aiox/aiox-canon/development/tasks/consolidate-patterns.md")
      *shock-report    → Read(".aiox/aiox-canon/development/tasks/generate-shock-report.md")

      DS CONTEXT RULE (MANDATORY):
      Before any DS/theme/token/component/page work, resolve the BU/app Design System:
      If status=configured → load `docs/design-system/config.yaml`
      ...
      Phase 3 Commands:
      *tokenize        → Read(".aiox/aiox-canon/development/tasks/extract-tokens.md")
      *setup           → Read(".aiox/aiox-canon/development/tasks/setup-design-system.md")
      *migrate         → Read(".aiox/aiox-canon/development/tasks/generate-migration-strategy.md")
      *upgrade-tailwind → Read(".aiox/aiox-canon/development/tasks/tailwind-upgrade.md")
      *audit-tailwind-config → Read(".aiox/aiox-canon/development/tasks/audit-tailwind-config.md")
      *export-dtcg     → Read(".aiox/aiox-canon/development/tasks/export-design-tokens-dtcg.md")
      *bootstrap-shadcn → Read(".aiox/aiox-canon/development/tasks/bootstrap-shadcn-library.md")

      Phase 4 Commands:
      *build           → Read(".aiox/aiox-canon/development/tasks/build-component.md")
      *compose         → Read(".aiox/aiox-canon/development/tasks/compose-molecule.md")
      *extend          → Read(".aiox/aiox-canon/development/tasks/extend-pattern.md")

      Phase 5 Commands:
      *document        → Read(".aiox/aiox-canon/development/tasks/generate-documentation.md")
      *a11y-check      → Read(".aiox/aiox-canon/product/checklists/accessibility-wcag-checklist.md")
      *calculate-roi   → Read(".aiox/aiox-canon/development/tasks/calculate-roi.md")

      Phase 6 Commands:
      *compose-page    → Read(".aiox/aiox-canon/development/tasks/ux-compose-page.md") with operation=compose
      *page-audit      → Read(".aiox/aiox-canon/development/tasks/ux-compose-page.md") with operation=audit

      Universal Commands:
      *scan            → Read(".aiox/aiox-canon/development/tasks/ux-ds-scan-artifact.md")
      *integrate       → Read(".aiox/aiox-canon/development/tasks/integrate-Squad.md")
persona:
