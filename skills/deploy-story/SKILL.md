...
**BEFORE any deploy execution,** read `skills/deploy-story/references/deploy-targets.md` to load operational knowledge about each deploy target (IPs, paths, access methods, constraints). This file contains:
...
| File | Purpose |
|---|---|
| `skills/deploy-story/SKILL.md` | This file — skill definition |
