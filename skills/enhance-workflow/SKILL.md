...
description: "Pipeline multi-agente para enhancement de projetos: Discovery → Research → Roundtable → Epic. Use ao planejar melhorias ou adicionar features complexas."
---

# Enhance Workflow

Pipeline multi-agente para enhancement de projetos usando Teams com agentes AIOX.
...
Phase 1: Discovery   → @architect (The Architect)     → 01-discovery.md
Phase 2: Research     → @analyst (Merovingian)      → 02-research.md
...
|----------|----------|-------------|
| Brownfield Discovery | `docs/guides/aiox-workflows/brownfield-discovery-workflow.md` | Technical mapping before enhancement |
| Story Development Cycle | `docs/guides/aiox-workflows/story-development-cycle-workflow.md` | 4 phases, feedback loops |
| IDS Protocol | `.claude/agents/dev.md` | **REUSE > ADAPT > CREATE** |
| Execute Epic Patterns | `skills/execute-epic/SKILL.md` | Task tool blocking, parallel agents |
...
Task(prompt: "...", subagent_type: "architect", mode: "bypassPermissions")
...
Task(prompt: "agent 1...", subagent_type: "architect", run_in_background: true)  → returns output_file_1
Task(prompt: "agent 2...", subagent_type: "data-engineer", run_in_background: true)  → returns output_file_2
Task(prompt: "agent 3...", subagent_type: "devops", run_in_background: true)  → returns output_file_3
Task(prompt: "agent 4...", subagent_type: "ux-design-expert", run_in_background: true)  → returns output_file_4
...
### Phase 1: Discovery (@architect / The Architect)
...
### Phase 2: Research (@analyst / Merovingian)
...
#### Agent 1: Architect (The Architect) - Architectural Perspective
- `name`: "rt-architect"
...
#### Agent 2: Data Engineer (Tank) - Data Perspective
...
#### Agent 3: DevOps (Link) - Infrastructure Perspective
- `name`: "rt-devops"
...
#### Agent 4: UX Expert (Trinity) - UX Perspective
- `name`: "rt-ux"
...
Also save the structured version for AIOX to:
docs/projects/{project_name}/epics/{slug}/epic.md

Use the standard AIOX epic format.
