---
name: "handoff"
description: "Generates a AIOX-compliant handoff that lets another AI resume work"
version: "3.1.0"
agent: "handoff"
user-invocable: true
maxTurns: 25
...
# Handoff Generator v3.1 (AIOX-Compliant)
...
process:
  ...
  compliance: 100/100
  reference: ".aiox/squad-runtime/aiox-squad/handoff-generation/"
```
...
Map extracted data to the 4 AIOX parameter categories:
...
1. Read the template: `skills/handoff/handoff-template.md`
...
**Always executes after ATM-008** (AIOX Extension 7 — Journey Log Universal).
...
AIOX Constitution requires human signoff before delivery.
