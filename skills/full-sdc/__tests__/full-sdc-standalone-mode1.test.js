 ...
 * `skills/full-sdc/SKILL.md` Phase 0c.2 ("Story file availability check").
 *
 ...
 *   `skills/wave-execute/__tests__/full-sdc-standalone-mode1.test.js` — that file
 ...
 *
 * Run: node --test skills/full-sdc/__tests__/full-sdc-standalone-mode1.test.js
 */
 ...
 *
 * MUST stay in sync with the ELSE-branch block in `skills/full-sdc/SKILL.md`
