...
The AIOX slides runtime exposes three surfaces (CLI, REST under
...
def run_cli(prompt: str, audience: str, objective: str) -> dict:
    cli_path = REPO_ROOT / "scripts/aiox/slides-cli.mjs"
...
def check_artifacts(run_id: str) -> dict:
    base = Path(os.environ.get("SLIDES_PROJECT_ROOT", REPO_ROOT / "outputs/slides-creator")) / run_id
    expected = [
