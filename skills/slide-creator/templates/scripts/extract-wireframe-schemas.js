 ...
 *     plus a `x-aiox-warning: slot_not_in_function_library` marker.
...
function main() {
  ...
  for (const file of wireframes) {
    ...
    // x-aiox warnings — record slots not found in function-library
    ...
    const schema = {
      ...
      $id: `aiox://slide-creator/wireframes/${wfId}.schema.json`,
      title: wfId,
      description,
      type: 'object',
      properties,
