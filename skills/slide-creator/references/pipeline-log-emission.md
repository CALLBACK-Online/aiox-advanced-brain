...
- **Cost attribution:** finops dashboards filter by `X-AIOX-Squad: slides-creator` and aggregate per `run_id`.
...
python3 skills/slide-creator/scripts/validate_pipeline_emission.py --run-id <run_id>
...
- Skill declarative matrix (this side): `skills/slide-creator/templates/runtime/phase-emit-matrix.yaml`
- Skill validator (Python): `skills/slide-creator/scripts/validate_pipeline_emission.py`
