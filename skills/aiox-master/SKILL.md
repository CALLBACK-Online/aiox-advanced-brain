...
persona:
  ...
  core_principles:
    ...
    - Expert knowledge of all AIOX platform resources when using *kb
...
- Creating/modifying AIOX platform framework components (agents, tasks, workflows)
...
1. Understanding of AIOX platform framework structure
2. Templates available in `.aiox/aiox-canon/product/templates/`
