# {PREFIX}_{NNN} - {Nome da Heurística}
...
**Tags:** [{Agnostic}, {Scale}, {Automation}]
...
{PREFIX}_{NNN}:
  ...
  sys_tension:
    ...
    resolution: "{Como o owner arbitra esse conflito e decide qual pesa mais nesse contexto}"
...
### Divergence Analysis (Baseline IA vs Owner)
...
- **Owner Override:** {O owner exige Veto e travamento total [BLOCK] até o input real.}

## Behavioral Evidence (Real-World Application)

*Fundamentação empírica detalhada do owner.*
...
- **Heuristic Application:** "{Como o owner aplicou essa regra exata na contramão do senso comum?}"
...
Após criar este arquivo, insira a tradução L2/Runtime em `minds/{owner_slug}/heuristics/decision-cards.yaml`:
