...
| `/aiox-pipeline` | Pipeline 7 fases com contexto de sessao |
...
```
docs/**                               # documentacao
outputs/allfluence/**               # local_docs YAML configs
...
**Path:** `.aiox/learning/logs/three-brain/three-brain-{context-id}-{YYYYMMDD}-{HHmmss}.yaml`

> Todas as skills do AIOX platform gravam logs em `.aiox/learning/logs/`.
