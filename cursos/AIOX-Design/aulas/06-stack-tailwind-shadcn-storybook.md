...
lesson_position: 6
title: "Tailwind + ShadCN + Storybook: stack canônica para IA"
module: M2
sequence: M2.1
status: canonical
...
[⌂ Curso](../README.md) · [↑ M2](../modulos/M2.md) · [← Anterior](05-tokens-componentes-anti-drift.md) · [Próxima →](07-storybook-variantes.md)
