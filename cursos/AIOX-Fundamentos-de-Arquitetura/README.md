...
title: AIOX — Fundamentos de Arquitetura de Sistemas
status: canonical
...
# AIOX — Fundamentos de Arquitetura de Sistemas
...
- Substituto do AIOX Advanced: este curso ensina o vocabulário; o Advanced ensina o método e a operação.
...
```bash
python3 "cursos/AIOX-Fundamentos-de-Arquitetura/_tools/validate_course.py"
```

## Ordem com as outras trilhas

```text
Obsidian + IA (opcional) → Fundamentos de Arquitetura → AIOX Advanced → Squads
```

Alunos experientes podem usar o diagnóstico e entrar direto no Advanced. Hub geral: `cursos/README.md`.
