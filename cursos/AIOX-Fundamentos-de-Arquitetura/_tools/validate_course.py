#!/usr/bin/env python3
"""Valida estrutura, pedagogia e links do curso de Fundamentos de Arquitetura."""
...
COURSE_ID = "aiox-fundamentos-arquitetura"
SCOPE = "cursos/AIOX-Fundamentos-de-Arquitetura"
EXPECTED_LESSONS = [
...
print(
    f"Fundamentos de Arquitetura: {len(lesson_files)} aulas, "
