...
source_path: content/courses/aiox-advanced/aulas/73-prontidao-de-producao/lesson.md
...
- **Objetivos da aula** (Checklist ≥10 com [[Evidência|evidência]]; Vermelhos com dono e risco; Go / no-go explícito)
