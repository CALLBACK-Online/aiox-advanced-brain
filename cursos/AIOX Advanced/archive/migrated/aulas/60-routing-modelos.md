...
source_path: content/courses/aiox-advanced/aulas/60-routing-modelos/lesson.md
...
Cara, [[Token Economy|token economy]] não é miséria. É **alocar inteligência onde ela
...
> **Materiais / FAQ**: 01 Token Economy · 17 [[Engenharia de Contexto|Engenharia de contexto]] · GUIA-AUTONOMIA-ECONOMIA-TOKENS
...
| Decisão produto  | Claude + humano    | [[Mesa-redonda|roundtable]]      | aceite explícito  |
...
Onde a política vive no AIOX: core-config, [[CLAUDE md|CLAUDE.md]] (atalhos), ou tabela
...
> **Próximo na trilha**: Aula 61 sobe a orquestração ao nível de épico: Wave Execute — partição, waves, fan-in e wall-clock de verdade.
