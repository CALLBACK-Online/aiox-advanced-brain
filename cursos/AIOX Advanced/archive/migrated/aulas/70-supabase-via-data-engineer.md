...
source_path: content/courses/aiox-advanced/aulas/70-supabase-via-data-engineer/lesson.md
...
- Tabela criada no calor do PR sem [[Migration|migration]] file.
...
Prior-art: [[Agentes Orbitais|agentes orbitais]] (45), ambientes (05), escada (69). Aqui a gente
...
Quando a cohort fala em app de verdade, a conversa migra de [[Squad|squad]] zip para
...
> **Próximo na trilha**: Solo pronto pede superfície no mundo: a aula de Vercel Deploy (71) tira o app do localhost com checklist de adulto.
