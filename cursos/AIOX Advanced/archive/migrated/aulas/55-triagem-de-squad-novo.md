...
source_path: content/courses/aiox-advanced/aulas/55-triagem-de-squad-novo/lesson.md
...
- Listar os itens do checklist de triagem de [[Squad|squad]] novo (prior-art, gap, recorrência, dono). _(remember)_
...
2. **ADAPT**: 80% + delta
3. **CREATE**: Gap + dono
4. **NÃO-SQUAD**: Task/[[Runner|runner]]
...
> **Trilha M4 neste bloco**: Rider (50) → entidades (51) → modos de execução (52) → [[Brownfield Discovery|brownfield]] (53) → R>A>C (54) → triagem (55). Daqui o curso segue pra UI/design system e paralelização.
