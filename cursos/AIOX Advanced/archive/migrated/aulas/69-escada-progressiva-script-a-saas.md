...
source_path: content/courses/aiox-advanced/aulas/69-escada-progressiva-script-a-saas/lesson.md
...
o script ensina o fluxo; o [[Squad|squad]] ensina papéis; o workflow ensina ritual; o
[[Runner|runner]] ensina determinismo; a API ensina contrato; o app ensina superfície;
...
> **Próximo na trilha**: Se o teu degrau já pede dados de verdade, a aula de Supabase via @data-engineer (70) materializa schema e RLS com o agente certo.
