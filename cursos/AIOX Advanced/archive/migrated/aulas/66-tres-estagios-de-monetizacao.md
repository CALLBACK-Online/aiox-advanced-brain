...
source_path: content/courses/aiox-advanced/aulas/66-tres-estagios-de-monetizacao/lesson.md
...
- Dono de entrega (você ou [[Squad|squad]]) com capacidade real.
...
> **Próximo na trilha**: Quando o valor precisa viver sem sua IDE aberta, a aula de harness (67) desenha o ambiente de execução fora do Claude Code.
