...
source_path: content/courses/aiox-advanced/aulas/52-workflow-vs-comando-manual/lesson.md
...
Prior-art: taxonomia task/skill/agent/workflow/runner (28) e [[Runner|runner determinístico]]
(30) já batizaram as peças. [[Goal vs Loop|Goal vs loop]] (11) lembra o que se persegue. Aqui
...
**Semana 1–2:** workflow guiado de [[Brownfield Discovery|brownfield discovery]]. Todo mundo segue as
...
> **Próximo na trilha**: Se o teu modo esbarra em código legado, a aula 53 (brownfield enhancement) amarra discovery → feature sem derrubar a casa.
