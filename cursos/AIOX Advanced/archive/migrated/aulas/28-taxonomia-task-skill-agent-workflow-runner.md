...
source_path: content/courses/aiox-advanced/aulas/28-taxonomia-task-skill-agent-workflow-runner/lesson.md
...
Task, Skill, Agente, Workflow e Runner não são sinônimos. São cinco níveis numa escala que vai do átomo de trabalho ao executável determinístico. Confundir os níveis é a causa raiz de [[Squad|squad]] inflado.
...
- Esperar decisão de um [[Runner|runner determinístico]].
