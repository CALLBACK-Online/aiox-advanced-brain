...
source_path: content/courses/aiox-advanced/aulas/58-ralph-paralelizacao/lesson.md
...
Mini-protocolo que eu gravo no [[CLAUDE md|CLAUDE.md]] do projeto quando o time escala:
...
> **Próximo na trilha**: Aula 59 fecha o critério: quando paralelizar vs sequencial — dependência mata speedup e você mede wall-clock de verdade.
