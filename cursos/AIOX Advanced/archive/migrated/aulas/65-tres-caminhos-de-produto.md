...
source_path: content/courses/aiox-advanced/aulas/65-tres-caminhos-de-produto/lesson.md
...
> **Próximo na trilha**: Com a pista escolhida, a aula dos três estágios de monetização (66) ordena o cash: interno → cliente → produto.
