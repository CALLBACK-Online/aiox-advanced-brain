...
source_path: content/courses/aiox-advanced/aulas/17-engenharia-de-contexto/lesson.md
...
← [[aulas/16-janela-de-contexto|Janela de contexto: o limite real e a degradação acima de 40K]] · ↑ [[modulos/Módulo 1 - Sistema e Contexto|M1 — Sistema e contexto]] · ⌂ [[cursos/AIOX Advanced/README|Curso]] · → [[aulas/18-yaml-markdown-json-sweet-spot|YAML, Markdown, JSON: o sweet spot para LLM]]
