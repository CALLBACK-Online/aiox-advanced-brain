...
source_path: content/courses/aiox-advanced/aulas/03-claude-md-leis-da-fisica/lesson.md
...
← [[aulas/26-nao-delegar-pensar|Nao delegue o pensar: repertorio contra zumbi]] · ↑ [[modulos/Módulo 1 - Sistema e Contexto|M1 — Sistema e contexto]] · ⌂ [[cursos/AIOX Advanced/README|Curso]] · → [[aulas/05-ambientes-local-staging-production|Local, Staging, Production]]
