...
source_path: content/courses/aiox-advanced/aulas/15-quatro-executores/lesson.md
...
← [[aulas/05-ambientes-local-staging-production|Local, Staging, Production]] · ↑ [[modulos/Módulo 1 - Sistema e Contexto|M1 — Sistema e contexto]] · ⌂ [[cursos/AIOX Advanced/README|Curso]] · → [[aulas/16-janela-de-contexto|Janela de contexto: o limite real e a degradação acima de 40K]]
