...
source_path: content/courses/aiox-advanced/aulas/19-ciclo-do-repositorio/lesson.md
...
Você descreve o ciclo Detect→branch→commit→[[CodeRabbit]]→CI→[[Merge|merge]]/deploy e aponta
...
← [[aulas/06-code-rabbit-boost|Code Rabbit Boost]] · ↑ [[modulos/Módulo 2 - SDC e Qualidade|M2 — SDC e qualidade]] · ⌂ [[cursos/AIOX Advanced/README|Curso]] · → [[aulas/46-etapas-de-desenvolvimento|Briefing, PRD, Stories: as 3 etapas antes do código]]
