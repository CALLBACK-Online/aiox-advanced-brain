...
1. **Obsidian + IA** (opcional, ~60–90 min) se o gargalo for estudar no vault com agent.
2. **AIOX Advanced — Rota Essencial** (ou, no mínimo, M1 + M5 + M7).
3. **AIOX Advanced Squads — aula 00** (como copiar e ativar).
4. Módulos do curso de Squads conforme a missão.
5. Voltar ao Advanced no Capstone / Projeto Integrador com os squads já escolhidos.
