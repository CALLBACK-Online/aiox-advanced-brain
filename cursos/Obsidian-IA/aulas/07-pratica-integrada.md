...
1. Confirme que o briefing não contém secrets nem paths privados.
2. Confirme que o asset está disponível no runtime real.
3. Execute a missão; não simule comandos ou integrações ausentes.
4. Valide o artefato com o gate do projeto ou uma inspeção objetiva adequada.
5. Registre o caminho do artefato e o resultado da validação.

Se a execução exigir credencial, efeito externo ou mudança destrutiva, escolha outra missão para este capstone. Um bloqueio não conta como conclusão.

## Retorno ao segundo cérebro

Crie uma nota pessoal com este formato:
