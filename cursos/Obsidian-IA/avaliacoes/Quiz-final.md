...
### 1. Você estudou uma skill no vault e quer vê-la executando de verdade. Pelas três superfícies da aula 00, onde isso acontece?

- A. No Obsidian, que executa as skills a partir do Graph
- B. No seu projeto, depois de copiar somente o asset necessário
- C. No GitHub, que roda as skills ao renderizar o markdown
- D. Dentro da própria aula canônica, editando-a para registrar o resultado

### 2. Você quer o Graph colorido com cursos, skills e squads no mesmo mapa. Qual pasta abre como vault?

- A. `cursos/AIOX Advanced/` — o grafo grande do método
- B. Só `cursos/Obsidian-IA/`, para começar leve
- C. A raiz do monorepo do seu projeto AIOX
- D. A raiz deste repositório (cursos + skills + squads)

### 3. Uma nota sua usa `[[Squad]]` e, fora do Obsidian (GitHub, agent), o link vira texto morto. O que a aula 02 recomenda?

- A. Traduzir o wikilink para um path relativo
- B. Instalar um plugin de IA que resolva wikilinks no navegador
...
- C. 1 captura ou MOC + 1 Context Brief + 1 artefato validado no projeto + 1 nota de retorno
- D. Um Context Brief salvo como `draft`, sem execução
