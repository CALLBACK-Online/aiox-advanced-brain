...
Antes de operar este squad, no curso **AIOX Advanced** (pasta `cursos/AIOX Advanced/aulas/`) revise: `46-etapas-de-desenvolvimento` — evidência antes de métrica solta.
