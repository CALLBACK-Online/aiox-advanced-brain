...
# Avaliações — AIOX Agent Engineering
...
Quizzes são recuperação ativa. A aprovação do curso depende do [Projeto Integrador](Projeto-Integrador.md) avaliado pela [Rubrica](Rubrica.md).
