...
source_lesson_id: 52
source_path: "cursos/AIOX Advanced/lessons/52-workflow-vs-comando-manual.md"
...
← Mapear entidades antes do Squad: 5 perguntas + ciclo de vida · ↑ M6 · ⌂ Curso · → Brownfield Discovery: entrar num projeto que já existe
...
[← Aula anterior](02-entidade-e-ciclo-de-vida.md) · [Curso](../README.md) · [Próxima aula →](04-subagents-vs-swarm.md)
