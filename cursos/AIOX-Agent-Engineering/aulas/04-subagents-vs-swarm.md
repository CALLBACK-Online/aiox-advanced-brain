...
source_lesson_id: 29
source_path: "cursos/AIOX Advanced/lessons/29-sub-agents-vs-swarm-agents.md"
source_version: 1.0.0
---
# Sub-agents versus Swarm-agents: isolado ou em rede

← Taxonomia AIOX: Task, Skill, Agente, Workflow e Runner · ↑ M5 · ⌂ Curso · → Runner: o executável determinístico do Workflow
...
[← Aula anterior](03-workflow-vs-comando.md) · [Curso](../README.md) · [Próxima aula →](05-runner-deterministico.md)
