...
source_lesson_id: 30
source_path: "cursos/AIOX Advanced/lessons/30-runner-executavel-deterministico.md"
source_version: 1.0.0
---
# Runner: o executável determinístico do Workflow

← Sub-agents versus Swarm-agents: isolado ou em rede · ↑ M5 · ⌂ Curso · → Mapear entidades antes do Squad: 5 perguntas + ciclo de vida
...
No grupo, o fio que liga token economy a runner é explícito: achar no squad o que
...
Adaptação autocontida da aula 30 do AIOX Advanced. A fonte histórica permanece registrada em `source_path`; este curso é o dono da progressão atual.

## Navegação

[← Aula anterior](04-subagents-vs-swarm.md) · [Curso](../README.md) · [Próxima aula →](06-pipeline-etl-com-agentes.md)
