...
- **Revisão de código** — A decisão é sobre correção de código, não estratégia nem arquitetura ampla.
  → _Review de código_
  Ex.: Use a lente certa de código (ex: /coderabbit-review), não um painel estratégico.
...
Adaptação autocontida da aula 35 do AIOX Advanced. A fonte histórica permanece registrada em `source_path`; este curso é o dono da progressão atual.
