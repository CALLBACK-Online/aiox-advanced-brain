...
- Desenhar uma pipeline CI com lint, typecheck, test e quality gate. _(apply)_
- Configurar branch protection exigindo checks obrigatórios antes do merge. _(apply)_
- Explicar o papel do QG pré-merge no determinismo progressivo do AIOX. _(understand)_
...
lint, test, build, deploy, análise de segurança, linter de markdown, cache de
...
Adaptação autocontida da aula 72 do AIOX Advanced. A fonte histórica permanece registrada em `source_path`; este curso é o dono da progressão atual.
