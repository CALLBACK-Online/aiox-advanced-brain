...
Runners-101 circulou como material da turma. Se o mapa do pipeline mostrou uma
etapa estabilizada, esta aula é o chão de fábrica: o executável do workflow.
...
[← Aula anterior](03-subagents-vs-swarm.md) · [↑ M0](../modulos/M0-arquitetura-da-capacidade.md) · [Curso](../README.md) · [Próxima aula →](05-entidade-e-ciclo-de-vida.md)
