...
source_lesson_id: 37
source_path: "cursos/AIOX Advanced/archive/migrated/aulas/37-spy-bench-comparativo.md"
...
Adaptação autocontida da aula 37 do AIOX Advanced. A fonte histórica permanece registrada em `source_path`; este curso é o dono da progressão atual.
