...
source_lesson_id: 59
source_path: "cursos/AIOX Advanced/archive/migrated/aulas/59-quando-paralelizar-vs-sequencial.md"
...
Adaptação autocontida da aula 59 do AIOX Advanced. A fonte histórica permanece registrada em `source_path`; este curso é o dono da progressão atual.
