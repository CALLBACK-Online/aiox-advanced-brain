...
source_lesson_id: 22
source_path: "cursos/AIOX Advanced/lessons/22-pipeline-etl-com-agentes.md"
source_version: 1.0.0
---
# Pipeline ETL com agentes: hierarquia de camadas

← Rider: quando o operador é o piloto · ↑ M4 · ⌂ Curso · → O que é um Squad (e por que ele vem antes do App)
...
onde entra agente vs runner. Resultado: diagrama ETL do teu caso com 3 camadas.
...
> **Próxima aula**: Você desenha pipelines em camadas e sabe onde a IA agrega. Com o determinismo dominado, M5 entra na arquitetura AIOX: o que é um squad e como as entidades viram unidades de processo.
...
Adaptação autocontida da aula 22 do AIOX Advanced. A fonte histórica permanece registrada em `source_path`; este curso é o dono da progressão atual.

## Navegação

[← Aula anterior](05-runner-deterministico.md) · [Curso](../README.md) · [Próxima aula →](07-mesa-redonda-e-advisory-board.md)
