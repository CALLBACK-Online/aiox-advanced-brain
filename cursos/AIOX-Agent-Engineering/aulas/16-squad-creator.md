...
> Você não escreve um squad na mão. Você descreve o domínio e deixa o Squad Creator montar agentes, tasks e workflows. A regra muda: antes de codar, você especifica. O /squad-creator é a fábrica que materializa a especificação.
...
Adaptação autocontida da aula 34 do AIOX Advanced. A fonte histórica permanece registrada em `source_path`; este curso é o dono da progressão atual.
