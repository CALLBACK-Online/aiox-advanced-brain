...
source_lesson_id: 54
source_path: "cursos/AIOX Advanced/archive/migrated/aulas/54-reuse-adapt-create-heuristica.md"
...
## NIH mata squad (e skill, e runner)
...
prior-art: taxonomia (28), anatomia e creator de squad (33–34), pasta OS (39).
...
Adaptação autocontida da aula 54 do AIOX Advanced. A fonte histórica permanece registrada em `source_path`; este curso é o dono da progressão atual.
