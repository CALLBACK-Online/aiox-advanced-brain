...
source_lesson_id: 68
source_path: "cursos/AIOX Advanced/archive/migrated/aulas/68-squad-fora-do-claude-code.md"
...
> Extrair squad não é colar o prompt numa rota. É empacotar personas, skills, gates, estado e tools com contrato de API.
...
Fase 2 — **job runner** no harness: POST cria job, worker roda o workflow,
...
Adaptação autocontida da aula 68 do AIOX Advanced. A fonte histórica permanece registrada em `source_path`; este curso é o dono da progressão atual.
