...
source_lesson_id: 51
source_path: "cursos/AIOX Advanced/lessons/51-mapear-entidades-antes-do-squad.md"
source_version: 1.0.0
---
# Mapear entidades antes do Squad: 5 perguntas + ciclo de vida

← Runner: o executável determinístico do Workflow · ↑ M5 · ⌂ Curso · → Workflow pronto vs comando manual: bicicleta com rodinha
...
Prior-art: o que é um squad (23) e entidade como unidade (24) plantaram a ideia.
...
Adaptação autocontida da aula 51 do AIOX Advanced. A fonte histórica permanece registrada em `source_path`; este curso é o dono da progressão atual.

## Navegação

[← Aula anterior](01-taxonomia-da-capacidade.md) · [Curso](../README.md) · [Próxima aula →](03-workflow-vs-comando.md)
