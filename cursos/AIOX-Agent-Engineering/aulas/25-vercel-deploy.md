...
3. **Env vars** por Preview / production (e Development se usar).
...
Adaptação autocontida da aula 71 do AIOX Advanced. A fonte histórica permanece registrada em `source_path`; este curso é o dono da progressão atual.
