...
3. Desenhar as **5 caixas mínimas** do harness pro teu agente/squad.
...
Adaptação autocontida da aula 67 do AIOX Advanced. A fonte histórica permanece registrada em `source_path`; este curso é o dono da progressão atual.
