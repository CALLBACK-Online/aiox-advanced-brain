...
*Processo · M0 Arquitetura da capacidade · Por Alan Nicolas*
...
> **Próxima aula**: Você já enxerga o pipeline em camadas. Agora classifique cada unidade como task, skill, agent, workflow ou runner antes de escolher a arquitetura definitiva.
...
[↑ M0](../modulos/M0-arquitetura-da-capacidade.md) · [Curso](../README.md) · [Próxima aula →](02-taxonomia-da-capacidade.md)
