...
pedaço repetível como software que roda — com agente, runner, API, fila.

Não é CRUD genérico "pra todo mundo". Não é "IA pra PMEs". É o teu serviço,
industrializado no ponto de alavancagem.

Prior-art: as aulas de squad e harness ensinam a máquina. Esta aula ensina
...
- Quality gate com evidência em todo PR.
