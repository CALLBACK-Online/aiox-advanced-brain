"""Checagens específicas — AIOX Fundamentals.
...
def run(ctx: Context) -> str | None:
    ...
    # Pacote do aluno (versionado). Bastidor editorial (COURSE-BRIEF, outline,
    # gap, validation-report, deviations) → docs/producao-cursos/aiox-fundamentals/
    REQUIRED_ROOT_FILES = [
        "README.md",
        "AGENT-GUIDE.md",
        "curriculum.yaml",
