...
// dev/courses/aiox-advanced-squads → repo root
const root = path.resolve(toolsDir, "../../..");
const course = path.join(root, "cursos/AIOX-Advanced-Squads");
const errors = [];
...
const evalsPath = "dev/courses/aiox-advanced-squads/routing-evals.json";
