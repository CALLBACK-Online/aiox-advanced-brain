...
- Before creating, search:
  1. `@synkraai/ds-core` component registry (see `squads/design-ops/rules/design-system-generation.md`)
...
- For `component / page / email / dashboard`: reference `@synkraai/ds-core` via import.
