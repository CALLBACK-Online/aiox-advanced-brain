...
composed:
  ...
  strengths:
    - "Clear separation of orchestration from execution"
    - "Enables parallel and sequential sub-task composition"
    - "State aggregation across multiple atoms"
    - "Workflow phase management"
    - "Reusable orchestration patterns"

  weaknesses:
    - "No direct execution capability"
    - "Depends entirely on sub-task availability"
    - "Coordination overhead"
    - "Debugging complexity across delegation chain"

  cost_model: "$ (coordination only)"
  speed_model: "Depends on sub-tasks"

  best_for:
    - "Parent tasks that invoke a molecule's atom sequence via workflow phases"
    - "Multi-step orchestration without direct execution"
  ...
  note: |
    Composed is an extension to the canonical 4-type taxonomy
    (Human/Agent/Worker/Hybrid). It was formalized in the squad-creator
    validation 2026-04-12 to address the gap where 15 orchestrator tasks
    had no canonical type.
```
