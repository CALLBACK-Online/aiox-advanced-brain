...
Input: request::install_skills_write
Output: artifact::install_skills_write
pre_condition: install-skills-prepare completed com execution plan e diretórios de destino criados
post_condition: skill files escritos em cada IDE com README.md gerado por surface
performance: deterministic Worker, < 30s, fail-loud em write error ou format conversion failure
Completion Criteria: all skill files escritos AND README.md por IDE gerado AND zero write errors
>>>>>>>> origin/oalanicolas:squads/squad-creator/tasks/install-skills-write.md
