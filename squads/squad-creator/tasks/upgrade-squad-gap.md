...
pre_condition: upgrade-squad-inventory completed com component inventory AND AIOX structural standards acessíveis
post_condition: gap report com compliance score, structural gaps prioritizados e checks S-CFG-* avaliados
performance: Agent, < 5 min, structured output com score breakdown por dimensão
Completion Criteria: compliance_score calculado AND gaps prioritizados (Critical/High/Medium/Low) AND gap report emitido
