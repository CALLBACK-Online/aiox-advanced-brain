...
pre_condition: domain e purpose fornecidos pelo usuário AND detect-squad-context executado para routing
post_condition: squad completo criado com config.yaml, agents, workflows, tasks, documentação e activation surfaces publicadas
performance: Composed, 5 sub-tasks sequenciais, veto em qualquer sub-task bloqueia pipeline
Completion Criteria: all 5 sub-tasks PASS AND squad funcional via smoke test AND registrado em ecosystem-registry
...
- request::create_squad  sub_task_failure:
