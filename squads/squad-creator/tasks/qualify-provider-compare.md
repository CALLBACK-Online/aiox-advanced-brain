...
pre_condition: reliability test completed AND baseline disponível AND best reliability run selecionado
post_condition: comparison report com 5 weighted dimensions scored e cost savings calculado
performance: Agent, < 5 min, structured comparison com evidence-based scoring
Completion Criteria: 5 dimensions scored (completeness, accuracy, reasoning, format, actionability) AND cost savings calculated
