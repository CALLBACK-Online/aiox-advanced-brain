...
pre_condition: squad-overview-metadata completed com squad_path validado
post_condition: structural package com directory tree, workflows, frameworks, integrações e quality gates documentados
performance: Agent, < 5 min, filesystem analysis com structured output
Completion Criteria: directory tree mapeada AND workflows catalogados AND integrações identificadas AND compliance status
...
- Target squad directory does not exist -> BLOCK
- Directory scan returns zero files (empty squad) -> BLOCK
