...
pre_condition: squad_name e phase_definitions fornecidos AND squad target existe AND pipeline qualification pendente
post_condition: pipeline scaffold completo (lib/, scripts/, templates/, handlers/) validado e persistido no squad
performance: Composed (5 subtasks), veto anti-overengineering na qualification, < 20 min total
Completion Criteria: qualification PASS AND scaffold renderizado AND self-tests PASS AND pipeline-runner-checklist aprovado
