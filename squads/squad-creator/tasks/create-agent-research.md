...
pre_condition: squad target existe em squads/{squad_name}/ AND templates/agent-tmpl.md acessível AND WebSearch disponível
post_condition: research_output com template carregado, 18 seções identificadas, domain research com frameworks e anti-patterns
performance: Agent, < 5 min, structured output com domain research e template sections mapeadas
Completion Criteria: template loaded AND squad validated AND domain research com >= 3 frameworks/metodologias identificadas
