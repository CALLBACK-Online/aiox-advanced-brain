...
pre_condition: create-agent-persona completed AND squad config.yaml carregado com agents existentes
post_condition: commands_output com command set, capabilities, dependency map e handoff scenarios definidos
performance: < 15 min (Hybrid — elicitation + autonomous mapping), escalate em conflito de handoff
Completion Criteria: >= 1 comando definido AND capabilities listadas AND dependency map completo AND handoffs mapeados
