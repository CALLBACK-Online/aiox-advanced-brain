...
pre_condition: discover-tools-scan completed com scan-results.yaml AND WebSearch/EXA disponível
post_condition: classified-tools.yaml com findings classificados por source type, domain relevance e quality signals
performance: Agent, < 5 min, structured search across MCP repos, escalate se search tools indisponíveis
Completion Criteria: candidate tools encontrados AND classificados por source/domain/quality AND classified-tools.yaml persistido
