...
pre_condition: domain e use cases definidos AND squad structure acessível AND write permissions para .aiox/squad-runtime/discovery/
post_condition: scan-results.yaml com internal capabilities mapeadas e capability gaps identificados
performance: Agent, < 5 min, structured scan sem external dependencies
Completion Criteria: internal capabilities inventoried AND capability gaps prioritized AND scan-results.yaml persistido
