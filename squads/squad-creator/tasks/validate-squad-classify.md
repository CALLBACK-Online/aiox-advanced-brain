...
pre_condition: validate-squad-preflight completed com signal data AND squad-type-definitions.yaml acessível
post_condition: squad type classificado (Expert/Pipeline/Hybrid/Operational) AND governance compliance scored
performance: Agent, < 5 min, deterministic type detection + compliance scoring em single pass
Completion Criteria: squad type detectado AND type-specific requirements loaded AND governance compliance score calculado
