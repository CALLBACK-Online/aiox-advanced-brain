...
pre_condition: baseline exists AND task é pt_br_critical AND skip_pt_br != true
post_condition: PT-BR quality scores (fluency, accuracy, completeness) avaliados por Opus em 3 prompts estruturados
performance: Agent, < 5 min, conditional (skip se task não é pt_br_critical), Opus como evaluator
Completion Criteria: 3 prompts executados AND fluency/accuracy/completeness scored AND PT-BR native vs translation assessed
