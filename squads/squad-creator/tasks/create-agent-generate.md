...
pre_condition: research, persona e commands phases completed com outputs disponíveis
post_condition: agent .md file salvo em squads/{squad_name}/agents/ com >= 300 linhas e voice consistency verificada
performance: Agent, < 5 min, fail-loud se template fill incompleto ou line count < 300
Completion Criteria: agent file >= 300 lines AND all 18 template sections preenchidas AND voice consistency check passed
