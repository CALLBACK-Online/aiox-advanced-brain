...
pre_condition: auto-heal-resolve completed com resolve_result AND rollback path disponível
post_condition: resultado verificado, rollback aplicado se necessário, log auditável persistido e veredito final emitido
performance: deterministic Worker, < 30s, rollback automático se fix parcial detectado
Completion Criteria: resultado pós-resolve verificado AND log auditável persistido AND veredito HEALED/ESCALATED/ROLLED_BACK
