...
pre_condition: create-squad-design completed AND directory structure criada AND agent roster com tier assignments disponível
post_condition: todos agents, orchestrator, workflows, tasks criados com cross-references wired e publish contract emitido
performance: Agent, < 5 min, fail-loud se template indisponível ou cross-reference quebrada
Completion Criteria: all agents created AND workflows wired AND documentation generated AND publish contract emitido
