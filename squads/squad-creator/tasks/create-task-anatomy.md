...
pre_condition: Phase 0 classification complete com executor type atribuído AND target squad validado
post_condition: task anatomy com todos 8 campos obrigatórios preenchidos via elicitation estruturada
performance: < 15 min (Hybrid — interactive elicitation), escalate se campo obrigatório não resolvido
Completion Criteria: all 8 Task Anatomy fields populated AND SC_ANA_001 passed AND anatomy_spec pronta para generation
