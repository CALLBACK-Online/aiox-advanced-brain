...
pre_condition: create-agent-research completed AND research_output disponível AND tier-system-framework.md acessível
post_condition: persona_spec com identity, scope, voice DNA, tier classificado e quality criteria definidos
performance: Agent, < 5 min, structured elicitation com user AND tier classification aplicada
Completion Criteria: persona_spec completa com name, role, scope, voice_dna e tier classificado
