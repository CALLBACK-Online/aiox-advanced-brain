...
pre_condition: gap report YAML válido com workflow_analyzed e pelo menos um gap/remediation item
post_condition: workflow melhorado com P1/P2 aplicados, diff report gerado e backup verificável
performance: Composed (6 subtasks), backup-first, < 15 min total, rollback em validação falha
Completion Criteria: P1 remediações aplicadas AND diff report gerado AND workflow final parseia YAML AND version bumped
