...
pre_condition: error_message e error_context capturados AND auto-heal pipeline ativo
post_condition: erro categorizado, severidade classificada e fix aplicado (se seguro) ou handoff para humano emitido
performance: < 15 min (Hybrid — diagnóstico + decisão fix/escalada), escalate se severidade critical sem safe fix
Completion Criteria: categoria e severidade definidas AND fix aplicado com evidência OR escalation handoff emitido
