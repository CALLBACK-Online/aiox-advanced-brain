...
pre_condition: discover-tools-evaluate completed com evaluated-tools.yaml AND scan-results.yaml disponíveis
post_condition: recommendations.yaml com impact-vs-effort matrix, quick wins e strategic investments priorizados
performance: < 15 min (Hybrid — ROI analysis + user review), escalate em conflito de prioridade
Completion Criteria: impact-vs-effort calculado AND integration plan com quick wins, strategic investments e evaluate-later
