...
pre_condition: pipeline persistido AND pipeline-runner-checklist.md acessível AND pipeline_design_contract disponível
post_condition: pipeline validado com 30-item checklist, self-tests executados, veredito PASS/FAIL emitido
performance: deterministic Worker, < 30s para checklist + < 2 min para self-tests, fail-loud em FAIL
Completion Criteria: pipeline-runner-checklist 30/30 items avaliados AND self-tests PASS AND veredito final emitido
