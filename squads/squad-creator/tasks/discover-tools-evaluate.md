...
pre_condition: discover-tools-classify completed com classified-tools.yaml disponível
post_condition: evaluated-tools.yaml com ranked shortlist de qualified candidates acima do quality threshold
performance: Agent, < 5 min, weighted scoring com 5 criteria, filter below threshold
Completion Criteria: tools scored com weighted criteria AND below-threshold filtered AND ranked shortlist produzida
