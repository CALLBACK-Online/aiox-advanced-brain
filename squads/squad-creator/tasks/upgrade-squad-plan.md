...
pre_condition: upgrade-squad-gap completed com gap report e priority list disponíveis
post_condition: upgrade plan priorizado com fases, effort estimates e approval status (approved ou pending)
performance: < 15 min (Hybrid — prioritization + user approval), auto mode bypassa approval gate
Completion Criteria: upgrade plan com fases priorizadas AND effort estimado por fase AND approval obtido (ou auto mode)
