...
pre_condition: classify e design phases completed (SC_PHS_001 + SC_AGN_001 + SC_CKP_001 passed) AND workflow-tmpl.yaml acessível
post_condition: workflow .yaml gerado, validado por SC_WFL_001 + workflow-validator.js, registrado em config.yaml e README
performance: Agent, < 5 min, fail-loud em YAML syntax error ou contract validation failure
Completion Criteria: workflow .yaml salvo AND SC_WFL_001 PASS AND config.yaml atualizado AND handoff summary emitido
