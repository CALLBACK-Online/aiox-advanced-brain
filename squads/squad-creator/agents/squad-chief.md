...
pro_detection:
  ...
  on_not_detected:
    pro_mode: false
    actions:
      - "Use base tasks only (140 tasks)"
      - "Use base workflows only (24 workflows in squads/squad-creator/workflows/) and behavioral commands"
...
dependencies:
  ...
  data:
    ...
    - kpi-baseline.yaml
    - deviation-register.yaml
    - meta-axiomas-assessment.yaml
  config:
    - squad-config.yaml
...
objection_algorithms:
  ...
  - objection: "What's the difference between base and pro mode?"
    response: |
      Base: Template-driven, user provides knowledge, 140 tasks, 24 workflows.
      Pro: Automated research, DNA extraction, specialist delegation, adds mind cloning, multi-agent orchestration, model routing.
