...
framework_task_metadata:
  ...
  outputs:
    - outputs/data/{slug}/churn-risk-model.yaml
    - outputs/data/{slug}/leading-indicators.yaml
    - outputs/data/{slug}/intervention-playbooks.yaml
    - outputs/data/{slug}/churn-alert-config.yaml
  pre_conditions:
    - at least 12 months of customer lifecycle data
    - ground-truth churn events labeled
  post_conditions:
    - risk score per customer produced with thresholds
    - CS intervention playbooks defined per risk tier
  acceptance_criteria:
    - leading indicators prioritized over lagging outcomes
    - risk model validated on historical churn (precision/recall)
    - intervention playbooks mapped to risk bands
    - integration with CLV for save-value prioritization
