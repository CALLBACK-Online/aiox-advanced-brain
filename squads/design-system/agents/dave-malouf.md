...
> **Status:** Active canonical Tier 1 agent for DesignOps mental model.
> Per **ADR-DS-OPS-MENTAL-MODEL** (2026-06-02 OPS-D1 + OPS-D2), Malouf's frameworks
> (Three Lenses, Maturity Model, Metrics Stack) are the canonical reference
> for design system **Operations** layer (`squads/design-ops/` Camada 3, /DS-OPS).
> Build-time mental models continue with `brad-frost` (Atomic Design) and
> `dan-mall` (Collaborative DS) in `squads/design-system/` (Camada 2, /DS).
> Phase 1 Cleanup Notice from 2026-05 RECINDIDA por ADR-DS-OPS-MENTAL-MODEL.
