...
Use the `asSlot` utility from @synkraai/ds-core to allow a component to render
...
```tsx
import { Button, asSlot } from '@synkraai/ds-core';
...
- @synkraai/ds-core exposes `asSlot` as a utility
