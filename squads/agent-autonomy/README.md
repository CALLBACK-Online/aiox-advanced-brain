...
├── config.yaml                    Configuracao consolidada (entry_agent, registry, use cases, QGs)
├── README.md
├── CHANGELOG.md
├── SETUP.md                       Guia de restauracao pos-zip
├── ARCHITECTURE.md                Tier diagram, handoff flows, workflows
├── agents/
│   ├── autonomy-chief.md          Orchestrador — triage e routing
│   ├── autonomy-auditor.md        Tier 0 — diagnostico e scoring
│   ├── agent-architect.md         Tier 1 — design e otimizacao
│   ├── reasoning-engineer.md      Tier 1 — reasoning patterns
│   ├── tool-smith.md              Tier 2 — construcao de tools
│   └── ecosystem-scout.md         Tier 2 — pesquisa open-source
├── tasks/
│   ├── audit-agent.md             Auditar agente (9 criterios + 4 FMs)
│   ├── create-autonomous-agent.md Criar agente L3+
│   ├── diagnose-autonomy-failure.md Diagnostico com 5 Whys
...
│   └── create-agent-flow.md       Fluxo completo de criacao
├── checklists/
