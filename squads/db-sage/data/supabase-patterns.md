...
db.xxx.supabase.co:5432/postgres  # protocol postgres; credentials via $DATABASE_URL

# ✅ Pooled connection (port 6543)
db.xxx.supabase.co:6543/postgres?pgbouncer=true  # protocol postgres; credentials via $DATABASE_URL
```
