...
IDE-FILE-RESOLUTION:
  ...
  - Example: model-decisions.md → squads/code-anatomist/tasks/model-decisions.md
...
metadata:
  ...
  changelog:
    ...
    - "1.0.0: Initial creation for code-anatomist squad"
...
*Squad: code-anatomist (TIER 1 - Master)*
