...
handoff_to:
  ross:
    ...
    agent_file: "squads/code-anatomist/agents/ronald-ross.md"
    when: |
  ...
  von_halle:
    ...
    agent_file: "squads/code-anatomist/agents/barbara-von-halle.md"
    when: |
  ...
  taylor:
    ...
    agent_file: "squads/code-anatomist/agents/james-taylor.md"
    when: |
  ...
  fowler:
    ...
    agent_file: "squads/code-anatomist/agents/martin-fowler.md"
    when: |
  ...
  witt:
    ...
    agent_file: "squads/code-anatomist/agents/graham-witt.md"
    when: |
  ...
  sbvr_checklist:
    ...
    tool_file: "squads/code-anatomist/checklists/sbvr-checklist.yaml"
    when: |
...
dependencies:
  tasks:
    - path: "squads/code-anatomist/tasks/diagnose-system.md"
      description: "Task de diagnóstico inicial do sistema legado"
    - path: "squads/code-anatomist/tasks/extract-rules.md"
      description: "Task de extração de regras de código"
    - path: "squads/code-anatomist/tasks/classify-rules.md"
      description: "Task de classificação de regras (RuleSpeak)"
    - path: "squads/code-anatomist/tasks/model-decisions.md"
      description: "Task de modelagem de decisões (TDM)"
    - path: "squads/code-anatomist/tasks/formalize-dmn.md"
      description: "Task de formalização em DMN"
    - path: "squads/code-anatomist/tasks/express-rules.md"
      description: "Task de expressão em linguagem natural"
    - path: "squads/code-anatomist/tasks/validate-sbvr.md"
      description: "Task de validação SBVR"
    - path: "squads/code-anatomist/tasks/audit-extraction.md"
      description: "Task de auditoria de completude"
    - path: "squads/code-anatomist/tasks/map-domain.md"
      description: "Task de mapeamento de domínio (DDD)"
    - path: "squads/code-anatomist/tasks/characterize-legacy.md"
      description: "Task de characterization tests para legado"

  workflows:
    - path: "squads/code-anatomist/workflows/full-extraction.yaml"
      description: "Workflow completo: diagnóstico → validação"
    - path: "squads/code-anatomist/workflows/quick-extraction.yaml"
      description: "Workflow simplificado para módulos pequenos"
    - path: "squads/code-anatomist/workflows/compliance-audit.yaml"
      description: "Workflow focado em auditoria de conformidade"
    - path: "squads/code-anatomist/workflows/brms-preparation.yaml"
      description: "Workflow focado em preparação para BRMS"
    - path: "squads/code-anatomist/workflows/refactoring.yaml"
      description: "Workflow focado em refatoração de regras no código"

  checklists:
    - path: "squads/code-anatomist/checklists/sbvr-checklist.yaml"
      description: "Checklist SBVR para validação de regras"
    - path: "squads/code-anatomist/checklists/extraction-quality.yaml"
      description: "Checklist de qualidade de extração"
    - path: "squads/code-anatomist/checklists/dmn-completeness.yaml"
      description: "Checklist de completude de modelos DMN"
    - path: "squads/code-anatomist/checklists/traceability-audit.yaml"
      description: "Checklist de auditoria de rastreabilidade"

  templates:
    - path: "squads/code-anatomist/templates/rule-catalog.yaml"
      description: "Template para catálogo de regras"
    - path: "squads/code-anatomist/templates/extraction-report.md"
      description: "Template para relatório de extração"
    - path: "squads/code-anatomist/templates/decision-table.yaml"
      description: "Template para decision table"
    - path: "squads/code-anatomist/templates/context-map.md"
      description: "Template para context map"
    - path: "squads/code-anatomist/templates/characterization-test.md"
      description: "Template para characterization test"
    - path: "squads/code-anatomist/templates/sbvr-vocabulary.yaml"
      description: "Template para vocabulário SBVR"
    - path: "squads/code-anatomist/templates/validation-report.md"
      description: "Template para relatório de validação"
    - path: "squads/code-anatomist/templates/triage-report.md"
...
|----------|----------------|--------|
| Pipeline completo (Phase 0) | Evans context-map + Ross rule-taxonomy (2 diagnósticos independentes) | `code-anatomist--eric-evans`, `code-anatomist--ronald-ross` |
...
1. Construir array de tasks para `/swarm-execute`:
   ```json
   [
     {"agent": "code-anatomist--eric-evans", "prompt": "Map bounded contexts para {system}. Source: {source_path}",
      "mode": "write", "effort": 5,
      "template": "squads/code-anatomist/templates/domain-map-tmpl.yaml",
      "file_set": ["outputs/code-anatomist/{slug}/discovery/context-map.md"]},
     {"agent": "code-anatomist--ronald-ross", "prompt": "Classify expected rule types para {system}. Source: {source_path}",
      "mode": "write", "effort": 5,
      "checklist": "squads/code-anatomist/checklists/extraction-quality.md",
      "file_set": ["outputs/code-anatomist/{slug}/discovery/rule-type-inventory.md"]}
   ]
   ```
...
### Agent ID Resolution
- Sempre usar ID completo com prefixo do squad: `code-anatomist--{agent-name}`
- Ex: `eric-evans` → `code-anatomist--eric-evans`
