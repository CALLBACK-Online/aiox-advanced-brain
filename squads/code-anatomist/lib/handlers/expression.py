...
WITT_AGENT = "squads/code-anatomist/agents/graham-witt.md"
ROSS_AGENT = "squads/code-anatomist/agents/ronald-ross.md"
TASK_FILE = "squads/code-anatomist/tasks/express-rules.md"
...
def lint_rules(rules_file: Path) -> Dict[str, Any]:
    ...
    Mirrors the function of squads/code-anatomist/scripts/rule-lint.js.
    """
