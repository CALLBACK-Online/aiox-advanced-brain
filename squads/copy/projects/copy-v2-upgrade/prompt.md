...
1. **RESEARCH PHASE** (follow `squads/squad-creator/workflows/research-then-create-agent.md`):
   - Check local knowledge first (`minds/`, `docs/research/`)
...
|------------|------|-----------|
| **Alex Hormozi** ⭐ | `minds/alex_hormozi/sources/` | **4 livros + 24 playbooks + programs** (GOLD for offers/funnels/ads) |
| **Dan Kennedy** | `minds/dan_kennedy/sources/books/` | 14 livros (Ultimate Marketing Plan, No B.S. series) |
| **Eugene Schwartz** | `minds/eugene_schwartz/sources/books/` | Breakthrough Advertising (PRIMARY) |
| **Gary Halbert** | `minds/gary_halbert/sources/` | Boron Letters + 90+ swipe files |
| **Claude Hopkins** | `minds/claude_hopkins/sources/obsidian/` | 7 módulos de análise |
| **Jon Benson** | `minds/jon_benson/sources/` | VSL methodology |
| **David Deutsch** | `minds/david_deutsch/sources/obsidian/` | Analysis files |

### Alex Hormozi Sources (MASSIVE LIBRARY)

**Books:** `minds/alex_hormozi/sources/01 Livros/`
- Livro 100M Ofertas → US-023 (create-offer)
- Livro 100M Leads → US-019 (lead-magnet)
- Livro 100m Modelos → upsells, downsells, funnels

**Playbooks:** `minds/alex_hormozi/sources/02 Playbooks/`
...
**Programs:** `minds/alex_hormozi/sources/03 Programas/`
...
```
1. LOCAL FIRST: minds/{slug}/sources/
2. EXISTING RESEARCH: docs/research/{slug}-*.md
3. ANALYSIS: minds/{slug}/analysis/
...
- PRIMARY: `minds/gary_halbert/sources/books/The Boron Letters.pdf`
- PRIMARY: `minds/eugene_schwartz/sources/books/Breakthrough Advertising.pdf`
- SWIPE: `minds/gary_halbert/sources/swipe/PDF/` (all 90+ letters)

**US-017 (create-headlines):**
- PRIMARY: `minds/eugene_schwartz/sources/books/Breakthrough Advertising.pdf`
- EXAMPLES: `minds/gary_halbert/sources/swipe/PDF/`

**US-022 (vsl-script):**
- PRIMARY: `minds/jon_benson/sources/`

**US-023 (create-offer):**
- PRIMARY: `minds/dan_kennedy/sources/books/No B.S. Price Strategy.pdf`
