...
eugene_schwartz:
  pdf_disponivel: true
  path: "minds/eugene_schwartz/sources/books/Breakthrough Advertising How to Write.pdf"
  artifacts: "minds/eugene_schwartz/artifacts/"

dan_kennedy:
  pdfs_disponiveis: true
  path: "minds/dan_kennedy/sources/books/"
  livros:
...
gary_halbert:
  ...
  swipe_path: "minds/gary_halbert/sources/swipe/PDF/"
  swipe_count: "90+ sales letters"
  knowledge_extract: "minds/gary_halbert/sources/gary_halbert_knowledge_extract.md"

alex_hormozi:
  pdfs_livros: false  # Pastas vazias
  artifacts_disponivel: true
  artifacts_path: "minds/alex_hormozi/artifacts/"
  artifacts:
...
```bash
ls -la minds/{mind}/sources/
ls -la minds/{mind}/artifacts/
```
