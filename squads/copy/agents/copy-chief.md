...
dependencies:
  ...
  checklists:
    ...
    - copy-anti-slop-checklist.md   # Cross-fit bench absorption 2026-05-19 (Jane Doe Effect + em-dash + filler words bans)
  data:
    - copywriting-kb.md
    - copy-anti-slop-bans.yaml      # Cross-fit bench 2026-05-19 — canonical bans (filler / generic names / startup-slop / fake numbers / em-dash / lorem ipsum)
    - register-aware-copy.yaml      # Cross-fit bench 2026-05-19 — brand vs product voice policy

pre_flight_review:
  description: >
    Cross-fit anti-slop pre-flight (bench-driven 2026-05-19). Run before approving
    any copy deliverable for handoff. Authority: .claude/rules/design-absolute-bans.md
  steps:
    - id: load_register_policy
      action: Read squads/copy/data/register-aware-copy.yaml
      determine: "register: brand | product based on brief signals"
      emit: briefing_normalized.register
    - id: load_anti_slop_canon
      action: Read squads/copy/data/copy-anti-slop-bans.yaml
      load: [filler_words_ban, generic_names_ban, startup_slop_names_ban, fake_numbers_ban, filler_phrases_ban, em_dash_ban, lorem_ipsum_ban]
    - id: scan_deliverable
      action: Run squads/copy/checklists/copy-anti-slop-checklist.md against the asset
      emit: qa/copy-anti-slop-report.yaml
      schema:
        ai_slop_score: 0-100
    ...
    - id: gate_decision
      ...
      warn_if: "21 <= ai_slop_score <= 60 OR 1+ P1 hits"
      pass_if: "ai_slop_score <= 20 AND zero P0"
    - id: handoff_or_rebrief
      if_block: "Return to copy-ops-worker with specific replacement guidance from copy-anti-slop-bans.yaml#replacement_strategy"
      if_warn: "Approve with caveat; note score in handoff packet"
      if_pass: "Approve for delivery"
