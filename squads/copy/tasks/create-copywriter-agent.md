...
outputs:
  ...
  analysis_files:
    - "minds/{slug}/analysis/frameworks.yaml"
    - "minds/{slug}/analysis/communication-dna.yaml"
    - "minds/{slug}/analysis/signature-phrases.yaml"
    - "minds/{slug}/analysis/authority-arsenal.yaml"
    - "minds/{slug}/analysis/objection-algorithms.yaml"
    - "minds/{slug}/analysis/{slug}-rules.yaml"
    - "minds/{slug}/analysis/validation-report.md"
```
...
- [ ] Output directory exists: minds/{slug}/analysis/
...
```bash
mkdir -p minds/{slug}/analysis
mkdir -p minds/{slug}/docs
```
...
- **File:** `minds/{slug}/analysis/frameworks.yaml`
...
- **File:** `minds/{slug}/analysis/communication-dna.yaml`
...
- **File:** `minds/{slug}/analysis/signature-phrases.yaml`
...
- **File:** `minds/{slug}/analysis/authority-arsenal.yaml`
...
- **File:** `minds/{slug}/analysis/objection-algorithms.yaml`
...
- **File:** `minds/{slug}/analysis/{slug}-rules.yaml`
...
- **File:** `minds/{slug}/analysis/validation-report.md`
...
| File | Location |
|------|----------|
| frameworks.yaml | `minds/{slug}/analysis/` |
| communication-dna.yaml | `minds/{slug}/analysis/` |
| signature-phrases.yaml | `minds/{slug}/analysis/` |
| authority-arsenal.yaml | `minds/{slug}/analysis/` |
| objection-algorithms.yaml | `minds/{slug}/analysis/` |
| {slug}-rules.yaml | `minds/{slug}/analysis/` |
| validation-report.md | `minds/{slug}/analysis/` |
