...
|-------|----------|---------|---------|
| Source Materials | `minds/{slug}/sources/` | 20 files | Framework extraction |
...
fields:
  ...
  - output_path: "Output path (default: minds/{slug}/analysis/frameworks.yaml)"
```
...
options:
  - Mind directory (minds/{slug}/sources/)
...
Save to: `minds/{slug}/analysis/frameworks.yaml`
