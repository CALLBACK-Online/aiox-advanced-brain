...
inputs:
  required:
    ...
    - frameworks_file: "minds/{slug}/analysis/frameworks.yaml"
    - signature_phrases_file: "minds/{slug}/analysis/signature-phrases.yaml"
  recommended:
    - communication_dna_file: "minds/{slug}/analysis/communication-dna.yaml"
    - authority_arsenal_file: "minds/{slug}/analysis/authority-arsenal.yaml"

outputs:
  primary:
    - Objection algorithms file: "minds/{slug}/analysis/objection-algorithms.yaml"
  specifications:
...
|-------|---------------|---------|
| Frameworks | `minds/{slug}/analysis/frameworks.yaml` | For reframe references |
| Signature Phrases | `minds/{slug}/analysis/signature-phrases.yaml` | For voice markers |
| Communication DNA | `minds/{slug}/analysis/communication-dna.yaml` | For vocabulary/tone |
| Authority Arsenal | `minds/{slug}/analysis/authority-arsenal.yaml` | For evidence types |
| Source Materials | `minds/{slug}/sources/` | For objection mining |
...
Read the frameworks file: `minds/{slug}/analysis/frameworks.yaml`
...
Read the phrases file: `minds/{slug}/analysis/signature-phrases.yaml`
...
Save to: `minds/{slug}/analysis/objection-algorithms.yaml`
