...
|-------|----------|---------|---------|
| Source Materials | `minds/{slug}/sources/` | 20 files | Pattern extraction |
| Psychometric Profile | `minds/{slug}/analysis/psychometrics.json` | Optional | Communication style mapping |
| Previous Frameworks | `minds/{slug}/analysis/frameworks.yaml` | Optional | Terminology cross-reference |
...
fields:
  ...
  - output_path: "Output path (default: minds/{slug}/analysis/communication-dna.yaml)"
```
...
Save to: `minds/{slug}/analysis/communication-dna.yaml`
