...
output_schema: {headline: "string", subheadline: "string", hero_section: "string", body_sections: "array[{heading, body}]", cta: "{text, urgency}", proof_stack: "array[string]", guarantees: "array[string]"}
---
