...
required_artifacts:
  voice_guide:
    path: "minds/{slug}/artifacts/voice_guide.md"
  ...
  writing_style:
    path: "minds/{slug}/artifacts/writing_style.yaml"
  ...
  communication_templates:
    path: "minds/{slug}/artifacts/communication_templates.md"
  ...
  frameworks_synthesized:
    path: "minds/{slug}/artifacts/frameworks_synthesized.md"
...
story_artifacts:
  mental_archeology:
    path: "minds/{slug}/sources/mental_archeology.yaml"
  ...
  interview_sources:
    path: "minds/{slug}/sources/interviews/"
  ...
  general_profile:
    path: "minds/{slug}/sources/geral.md"
...
optional_artifacts:
  system_prompt:
    path: "minds/{slug}/system_prompts/system-prompt-generalista.md"
    purpose: "System prompt completo (use se precisar de contexto deep)"
    when_to_load: "Copy muito complexa ou longa"

  language_forensics:
    path: "minds/{slug}/sources/language_forensics.md"
