---
task: Create JV Launch Task
responsável: @copy-chief
responsavel_type: Clone
atomic_layer: Strategy
Entrada: |
  - briefing do JV launch, oferta principal e objetivo comercial
  - contexto de parceiros, avatar, provas, assets e restrições do acordo
  - métricas, referências e materiais de apoio relevantes para o lançamento
Saída: |
  - plano de JV launch alinhado ao framework descrito na task
...
Domain: Strategic
pre_condition: |
  - briefing, contexto e inputs mínimos carregados
  - restrições e assets confirmados antes da execução
post_condition: |
  - entregável principal registrado com critérios de revisão
  - handoff ou próximo passo explícito documentado
performance: |
  - sla_target: "PT24H"
  - error_handling: "registrar bloqueio e escalar para @copy-chief"
---
...
- [ ] Partner EPC: [EPC_SAUDÁVEL_EXEMPLO] (healthy indicator)
