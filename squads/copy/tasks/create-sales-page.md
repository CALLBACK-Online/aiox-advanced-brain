...
output_schema: {headline: string, subheadline: string, body_sections: "array[{heading, body}]", cta: "{text, urgency}", proof_stack: "array[string]", guarantees: "array[string]", faq_objections: "array[{question, answer}]"}
---
...
# Fonte: minds/gary_halbert/sources/swipe/PDF/ (90+ sales letters)
# Fonte: minds/gary_halbert/sources/gary_halbert_knowledge_extract.md
# ═══════════════════════════════════════════════════════════════════════════
...
**[Fonte: Análise de estrutura comum em minds/gary_halbert/sources/swipe/PDF/]**
...
swipe_files_disponiveis:
  path: "minds/gary_halbert/sources/swipe/PDF/"
...
**[Fonte: Listagem de minds/gary_halbert/sources/swipe/PDF/]**
...
*Fonte primária: minds/gary_halbert/sources/swipe/PDF/ (90+ letters)*
*Fonte secundária: minds/gary_halbert/sources/gary_halbert_knowledge_extract.md*
