...
| **Governance Policy** | AIOX Agent Authority Rules (`.claude/rules/agent-authority.md`)                   |
...
| 0.4.1 | 2026-05-08 | Rules Consolidation Audit | Phantom-ref fix. Governance Policy ref `.claude/rules/aiox-rules.md` (introduced in v0.3.0 NF-01) pointed to a file that never existed in the repo. Updated to `.claude/rules/agent-authority.md` — the canonical AIOX agent authority document. No other content changed; SOP body unaffected. |
