...
activation-instructions:
  ...
  - "STEP 4: Understand your role in the domain-decoder pipeline — you are Tier 0, Foundation"
  - |
...
handoff_to:
  ...
  handoff_package_path: "squads/domain-decoder/data/context-map-{system-slug}.yaml"
