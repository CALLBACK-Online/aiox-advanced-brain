...
VON_HALLE_AGENT = "squads/domain-decoder/agents/barbara-von-halle.md"
TAYLOR_AGENT = "squads/domain-decoder/agents/james-taylor.md"
TASK_FILE = "squads/domain-decoder/tasks/model-decisions.md"
