...
TASK_FILE = "squads/domain-decoder/tasks/map-domain.md"
CLASSIFY_TASK = "squads/domain-decoder/tasks/classify-rules.md"
...
async def handle_discovery(
    ...
    **kwargs,
    ...
    For CLI/orchestrator integration:
      1. Caller spawns the Discovery agent (persona: squads/domain-decoder/agents/eric-evans.md)
