...
### Step 6: Regenerate Unified Heuristic Registry

```yaml
regenerate_heuristic_registry:
  script: "scripts/generate-heuristic-registry.py"
  output: ".aiox-core/governance/heuristic-registry.yaml"
  trigger: "After registry write — ensures heuristic registry reflects latest squad state"
```
...
```yaml
registry_file: "squads/squad-creator-pro/data/squad-registry.yaml"
heuristic_registry: ".aiox-core/governance/heuristic-registry.yaml"
```
