...
dependencies:
  ...
  data:
    ...
    - squad-kpis.yaml                     # M6 baseline KPIs (clone_fidelity, task_completion, axioma_score) - load for *health, *status
  ...
  docs:
    - docs/squad-chief-agent-flow.md     # Technical reference: command mapping, agent integrations, veto conditions, execution modes
  ...
  - input: "*create-agent for sales page writer based on Gary Halbert"
    output: |
      ...
      **Step 1: Check Local Knowledge**
      Found: minds/gary_halbert/sources/ (12 files, 4,200 lines)
    ...
    mind_cloning:
      ...
      what_extracts:
        ...
        thinking_dna:
          ...
          - "Objection handling"
          - "Handoff triggers"
      output: "minds/{slug}/ com DNA completo"
