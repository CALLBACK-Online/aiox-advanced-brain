...
```yaml
sources:
  mind_artifacts: minds/alex_hormozi/artifacts/
  ...
  mental_models: minds/alex_hormozi/artifacts/mental_models.yaml
...
mmos:
  ...
  state_path: minds/alex_hormozi/metadata/state.json
  log_source: true
