...
> [DEPRECATED — 2026-05-19] This agent has been deprecated as of Story RA-E.1.
> Use @research-chief instead. Direct invocation of @dr-orchestrator returns:
> "This agent is deprecated. Please use @research-chief for all research pipeline operations."
> Alias: outputs/qa/aliases-pending-registry.yaml (@dr-orchestrator → @research-chief)
