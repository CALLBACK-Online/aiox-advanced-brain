...
input_schema:
  ...
  hypotheses: [string]
output_schema:
  pre_mortem: [{scenario, likelihood, impact}]
  system1_assumptions: [string]
  steelman_counter: [{position, evidence}]
