...
status: dormant
input_schema:
  claims_re_devops: [{text, sources[]}]
output_schema:
  dora_alignment: {deployment_freq, lead_time, change_failure, mttr}
  missing_metrics: [string]
  antipatterns_detected: [{pattern, evidence}]
