...
input_schema:
  brief: string
  evidence_so_far: [{claim, sources}]
output_schema:
  design_rationale: string
  sequence: [{phase_id, method: qual|quant|mixed}]
  integration_points: [{phase_a, phase_b, integration_type}]
