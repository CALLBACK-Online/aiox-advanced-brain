...
> **Conditional section — include ONLY for comparison/category queries (when the query implies a set of alternatives, tools, platforms, or entities).**

```yaml
scope_declaration:
  requested_category: "<category named or implied by user>"
  inclusion_criteria:
    - "criterion 1"
    - "criterion 2"
  included_in_report:
  ...
  excluded_with_reason:
    - entity: "<entity>"
      reason: "out_of_scope | low_corpus_coverage | different_subcategory | not_yet_evaluated"
```
