...
- IMPERADOR: <dropbox>/[AGENTES GPT]/AGENTE IMPERADOR/
...
- BLAZE: <dropbox>/[AGENTES GPT]/AGENTE BLAZE/
...
- BRANDCONTENT: <dropbox>/[AGENTES GPT]/BRANDCONTENT/
...
<local-claude-cache>/narrativas-extraction-result.txt
