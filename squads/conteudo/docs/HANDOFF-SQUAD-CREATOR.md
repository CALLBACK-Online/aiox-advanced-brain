...
**Raiz:** `<dropbox>/[AGENTES GPT]/AGENTE IMPERADOR/`
...
**Raiz:** `<dropbox>/[AGENTES GPT]/AGENTE BLAZE/`
...
**Raiz:** `<dropbox>/[AGENTES GPT]/BRANDCONTENT/`
...
Arquivos que existem em `<legacy-repo>/squads/conteudo/` -- podem ser reaproveitados ou descartados:
