...
commands:
  ...
  '*elicit-brand-yaml {slug}': "Full brand guidelines elicitation (→ brandbook.yaml)"
...
output_formats:
  ...
  value_proposition_md:
    path: "workspace/{spoke}/L1-strategy/value-proposition.yaml"
    template: |
...
workspace_ownership:
  primary:
    - workspace/{spoke}/L1-strategy/icp.yaml
    - workspace/{spoke}/L1-strategy/value-proposition.yaml
    - workspace/{spoke}/L1-strategy/elevator-pitch.yaml
    - workspace/{spoke}/L2-tactical/brand/brandbook.yaml
  collaboration:
    - workspace/{spoke}/L3-product/ (posicionamento de cada produto)
    - workspace/{spoke}/L0-identity/company-dna.yaml (com CEO)
...
| File | Content |
|------|---------|
| `L1-strategy/icp.yaml` | Ideal Customer Profile |
| `L1-strategy/value-proposition.yaml` | Proposta de valor |
| `L1-strategy/elevator-pitch.yaml` | Pitch de 30 segundos |
| `L2-tactical/brand/brandbook.yaml` | Brand guidelines |
| `L3-product/positioning.yaml` | Product positioning |
