 ...
 *
 * Uso:
 *   node squads/c-level/scripts/scan-diagnostic-backlog.cjs
 *   node squads/c-level/scripts/scan-diagnostic-backlog.cjs --business=aiox
 *   node squads/c-level/scripts/scan-diagnostic-backlog.cjs --format=full
 */
