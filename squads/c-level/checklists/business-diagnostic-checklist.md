...
- [ ] `L1-strategy/diagnosis.yaml` existe
- [ ] `L1-strategy/icp.yaml` existe
- [ ] `L1-strategy/analytics.yaml` existe
...
- [ ] `L2-tactical/brand/brandbook.yaml` existe (fallback se brandbook ausente)
...
- [ ] `L3-product/*/offerbook.yaml` existe (pelo menos 1 produto)
- [ ] `L3-product/*/proof.yaml` existe
- [ ] `L3-product/*/testimonials.yaml` existe
...
- [ ] `L3-product/*/narrative/brandscript.yaml` existe
- [ ] `L3-product/*/narrative/product-story.yaml` existe
- [ ] `L3-product/*/narrative/pitch-narrative.yaml` existe
- [ ] `L3-product/*/narrative/objection-destroyers.yaml` existe
- [ ] `L0-identity/authority-story.yaml` existe
...
- [ ] `L3-product/*/marketing/buyer-journey.yaml` existe
- [ ] `L3-product/*/marketing/conversion-funnel.yaml` existe
- [ ] `L3-product/*/marketing/email-sequences.yaml` existe
- [ ] `L3-product/*/marketing/campaign-brief.yaml` existe
...
- [ ] `L1-strategy/team-structure.yaml` existe
- [ ] `L1-strategy/pricing-strategy.yaml` existe
- [ ] `L1-strategy/kpi-scorecards.yaml` existe
- [ ] `L1-strategy/commission-design.yaml` existe
...
- [ ] `L3-product/*/curriculum.yaml` existe
- [ ] `L3-product/*/onboarding/onboarding-flow.yaml` existe
- [ ] `L3-product/*/retention/churn-prevention.yaml` existe
- [ ] `L3-product/*/retention/nps-feedback-loop.yaml` existe
...
- [ ] `L1-strategy/analytics.yaml` existe
- [ ] `L3-product/*/proof.yaml` existe
- [ ] `L0-identity/credentials.yaml` existe
- [ ] `L0-identity/authority-story.yaml` existe
