...
Preencher `workspace/{spoke}/L1-strategy/tech-stack.yaml` (a partir de `workspace/_templates/tech-stack.yaml`):
...
- [ ] Arquivo salvo em `workspace/{spoke}/L1-strategy/tech-stack.yaml`
