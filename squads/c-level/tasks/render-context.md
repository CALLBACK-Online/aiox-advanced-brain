...
- Resolver wildcards `L3-product/*` listando diretórios reais
...
resolve_paths:
  ...
  wildcards:
    "L3-product/*": "listar ls workspace/businesses/{slug}/L3-product/"
```
...
extraction_rules:
  ...
  _exists_any:
    ...
    method: "Verificar se pelo menos 1 match de L3-product/*/file.yaml existe"
    output: boolean
