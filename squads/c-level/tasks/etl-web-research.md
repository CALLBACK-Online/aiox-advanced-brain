...
Output:
- evidence/web-research-summary.yaml
pre_condition:
...
1. Ler `workspace/businesses/{slug}/L0-identity/company-dna.yaml` para obter `company_name` e `founder_name`.
...
3. Atualizar YAMLs do workspace:
   - `workspace/businesses/{slug}/L0-identity/credentials.yaml` — cobertura de midia, metricas sociais, dados de app.
   - `workspace/businesses/{slug}/L3-product/{product}/proof.yaml` — evidencias de terceiros.
   - `workspace/businesses/{slug}/L3-product/{product}/testimonials.yaml` — depoimentos e reviews de UGC.
   - `workspace/businesses/{slug}/L0-identity/authority-story.yaml` — narrativa de autoridade do fundador.
4. Atualizar `L4-operational/evidence/etl-run-envelope.yaml` com metricas da Layer 3.
...
| Output | Descricao |
|--------|-----------|
| `L0-identity/credentials.yaml` | Credenciais atualizadas com midia e social |
| `L3-product/{product}/proof.yaml` | Evidencias de terceiros |
| `L3-product/{product}/testimonials.yaml` | Depoimentos e reviews de UGC |
| `L0-identity/authority-story.yaml` | Narrativa de autoridade do fundador |
| `L4-operational/evidence/etl-run-envelope.yaml` | Envelope atualizado com metricas Layer 3 |
