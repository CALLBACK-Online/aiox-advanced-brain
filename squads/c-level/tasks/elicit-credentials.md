...
task:
  ...
  elicit: true
  output_format: yaml
  target_template: L0-identity/credentials.yaml
```
## SINKRA Contract
...
1. Ler `workspace/{spoke}/L0-identity/credentials.yaml`:
...
2. Ler `workspace/{spoke}/L0-identity/founder-dna.yaml` (se existir) para contexto.
...
- [ ] Arquivo salvo em `workspace/{spoke}/L0-identity/credentials.yaml`
