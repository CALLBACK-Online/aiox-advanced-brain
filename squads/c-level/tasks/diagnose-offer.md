...
- Produto existe: `workspace/businesses/{slug}/L3-product/{product}/`
...
| Testimonials insuficientes | c-level (CMO) | `*elicit-testimonials {slug}` |
| Sem garantia | hormozi | `/hormozi *guarantee-design` |
| Sem análise competitiva | spy | `/research-chief *competitive-intel` |
