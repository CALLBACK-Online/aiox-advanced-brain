...
lever:
  ...
  files_to_fill:
    ...
    - "L1-strategy/diagnosis.yaml"
    - "L1-strategy/analytics.yaml"
...
Se sim, adicionar em `workspace/businesses/{slug}/L1-strategy/diagnostic-backlog.yaml` com `source_diagnostic: "growth-levers"` e prioridade baseada no ranking.
