...
Preencher `workspace/{spoke}/L1-strategy/ai-strategy.yaml` (a partir de `workspace/_templates/ai-strategy.yaml`):
...
- [ ] Arquivo salvo em `workspace/{spoke}/L1-strategy/ai-strategy.yaml`
