...
1. Se for termo técnico geral ou arquitetura de sistemas, abra `cursos/Introducao-a-Arquitetura-de-Sistemas/AGENT-GUIDE.md`; se for dúvida de método AIOX, abra o curso principal.
