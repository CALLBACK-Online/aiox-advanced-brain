...
<!--
  ...
  Squad-side bindings (process_id, sinkra_tier, owner_squad) live in squads/slides-creator/config.yaml.
-->
...
11. **Package + emit pipeline log (Mandamento 10)**
   ...
   - **Python validator (always available):** `python3 .claude/skills/slide-creator/scripts/validate_pipeline_emission.py --run-id <id>`
