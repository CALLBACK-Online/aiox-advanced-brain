...
## 2026-07-06 — .claude/skills/tech-research/SKILL.md
...
| `squads/research/workflows/tech-research/tech-research-pipeline.yaml` NEW | Aggregate manifest (process_mapping target). Pattern parity with `sinkra-pipeline.yaml`. |
