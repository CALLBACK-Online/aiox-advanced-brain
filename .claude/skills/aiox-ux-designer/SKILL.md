...
IDE-FILE-RESOLUTION:
  ...
  - templates/data map to .sinkra/aiox-canon/product/{type}/{name}
  - type=folder (tasks|templates|checklists|data|workflows|etc...), name=file-name
  - Example: audit-codebase.md -> .sinkra/aiox-canon/development/tasks/audit-codebase.md
...
agent:
  ...
  customization:
    DESIGN_PLAYBOOK: |
      ...
      Phase 1 Commands:
      *research        → Read(".sinkra/aiox-canon/development/tasks/ux-user-research.md")
      *wireframe       → Read(".sinkra/aiox-canon/development/tasks/ux-create-wireframe.md")
      *generate-ui-prompt → Read(".sinkra/aiox-canon/development/tasks/generate-ai-frontend-prompt.md")
      *create-front-end-spec → Read(".sinkra/aiox-canon/development/tasks/create-doc.md") + Read(".sinkra/aiox-canon/product/templates/front-end-spec-tmpl.yaml")

      Phase 2 Commands:
      *audit           → Read(".sinkra/aiox-canon/development/tasks/audit-codebase.md")
      *consolidate     → Read(".sinkra/aiox-canon/development/tasks/consolidate-patterns.md")
      *shock-report    → Read(".sinkra/aiox-canon/development/tasks/generate-shock-report.md")
      ...
      Phase 3 Commands:
      *tokenize        → Read(".sinkra/aiox-canon/development/tasks/extract-tokens.md")
      *setup           → Read(".sinkra/aiox-canon/development/tasks/setup-design-system.md")
      *migrate         → Read(".sinkra/aiox-canon/development/tasks/generate-migration-strategy.md")
      *upgrade-tailwind → Read(".sinkra/aiox-canon/development/tasks/tailwind-upgrade.md")
      *audit-tailwind-config → Read(".sinkra/aiox-canon/development/tasks/audit-tailwind-config.md")
      *export-dtcg     → Read(".sinkra/aiox-canon/development/tasks/export-design-tokens-dtcg.md")
      *bootstrap-shadcn → Read(".sinkra/aiox-canon/development/tasks/bootstrap-shadcn-library.md")

      Phase 4 Commands:
      *build           → Read(".sinkra/aiox-canon/development/tasks/build-component.md")
      *compose         → Read(".sinkra/aiox-canon/development/tasks/compose-molecule.md")
      *extend          → Read(".sinkra/aiox-canon/development/tasks/extend-pattern.md")

      Phase 5 Commands:
      *document        → Read(".sinkra/aiox-canon/development/tasks/generate-documentation.md")
      *a11y-check      → Read(".sinkra/aiox-canon/product/checklists/accessibility-wcag-checklist.md")
      *calculate-roi   → Read(".sinkra/aiox-canon/development/tasks/calculate-roi.md")

      Phase 6 Commands:
      *compose-page    → Read(".sinkra/aiox-canon/development/tasks/ux-compose-page.md") with operation=compose
      *page-audit      → Read(".sinkra/aiox-canon/development/tasks/ux-compose-page.md") with operation=audit

      Universal Commands:
      *scan            → Read(".sinkra/aiox-canon/development/tasks/ux-ds-scan-artifact.md")
      *integrate       → Read(".sinkra/aiox-canon/development/tasks/integrate-Squad.md")
persona:
