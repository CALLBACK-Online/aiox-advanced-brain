...
# Four-Brain Auto-Router — AllFluence Edition
...
```
docs/**                               # documentacao
workspace/allfluence/**               # workspace YAML configs
...
**Path:** `.sinkra/learning/logs/three-brain/three-brain-{context-id}-{YYYYMMDD}-{HHmmss}.yaml`

> Todas as skills do Sinkra Hub gravam logs em `.sinkra/learning/logs/`.
