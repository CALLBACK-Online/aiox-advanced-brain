...
Port all task logic from `.sinkra/aiox-canon/development/tasks/dev-develop-story.md` into this skill so `/develop` is equivalent to running the full 925-line task. This skill covers: 3 execution modes, constitutional gates, CodeRabbit self-healing, decision logging, Code Intelligence Check, story file restrictions, blocking conditions, deploy awareness, and post-execution learning.
...
3. **Completion**
   ...
   - Execute `.sinkra/aiox-canon/product/checklists/story-dod-checklist.md`
...
7. **`.sinkra/aiox-canon/product/checklists/story-dod-checklist.md` executed**
...
- `.sinkra/aiox-canon/product/checklists/story-dod-checklist.md` — Definition of Done checklist
...
- [ ] `.sinkra/aiox-canon/product/checklists/story-dod-checklist.md` executed in full
