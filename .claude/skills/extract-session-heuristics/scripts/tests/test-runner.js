...
// ================================================================
// T17 — sinkra-operator npm script works
// ================================================================

test('T17 npm run sinkra:operator -- list works', () => {
  try {
    const stdout = execSync('npm run sinkra:operator -- list 2>&1', {
      cwd: REPO_ROOT,
      encoding: 'utf-8',
    });
    ...
    throw new Error(`npm run sinkra:operator -- list failed: ${err.message}`);
  }
});
